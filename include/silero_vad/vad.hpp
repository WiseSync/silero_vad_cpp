...
public:
    ...
    SileroVAD(const std::string& ModelPath,
        ...
        float Threshold = 0.35, const std::chrono::milliseconds& min_silence_duration_ms = std::chrono::milliseconds(0),
        const std::chrono::milliseconds& speech_pad_ms = std::chrono::milliseconds(64), 
        const std::chrono::milliseconds& min_speech_duration_ms = std::chrono::milliseconds(1024),
